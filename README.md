...
Additionally, I tested accuracy with different verisons of my dataset with some initial image manipulation. The three datasets are: Original, Greyscale, and removed background. The Dataset isn't hosted on this repository because of its size and to avoid any copyright issues with Moon-Board. 
